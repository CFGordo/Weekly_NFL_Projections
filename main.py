...
projections_db_link = 'https://docs.google.com/spreadsheets/d/1h-W-Oc3jlDAtUSDns9xqdc6WcJKAnWwJx1ulcApfdp4/edit#gid=1718966120'
...
cell_styles3 = {
            ...
            "styleConditions": [
                {
                    "condition": "params.value != 17.2023",
                    "style": {"color": "violet"},
                },
            ],
        }
