...
projections_db_link = 'https://docs.google.com/spreadsheets/d/1Kh3DiI3AT1zGnGmKS-Terpgr11SPZW87izjlIipghp4/edit#gid=275345456'
...
cell_styles2 = {
            ...
            "styleConditions": [
                {
                    "condition": "params.value >=2.2",
                    "style": {"color": "green"},
                },
                {
                    "condition": "params.value <= 1.6",
                    "style": {"color": "violet"},
                },
            ],
        }
